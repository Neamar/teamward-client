...
import fr.neamar.lolgamedata.AccountsActivity;
...
public class AccountAdapter extends RecyclerView.Adapter<AccountHolder> {
    ...
    public final AccountsActivity accountsActivity;
    private final View emptyView;
    private final RecyclerView recyclerView;

    public AccountAdapter(ArrayList<Account> accounts, AccountsActivity accountsActivity, View emptyView, RecyclerView recyclerView) {
